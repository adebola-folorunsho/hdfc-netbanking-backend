...
/**
 * Global exception handler for Currency Service.
 *
 ...
 * are ever returned directly to callers — always a clean JSON body.</p>
 *
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles ExchangeRateNotFoundException — thrown when a rate
     * cannot be found in Redis cache or from ExchangeRate-API.
     *
     * @param exception the thrown exception
     * @return 404 NOT FOUND with structured error body
     */
    @ExceptionHandler(ExchangeRateNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleExchangeRateNotFoundException(
            ExchangeRateNotFoundException exception) {

        log.warn("Exchange rate not found: {}", exception.getMessage());
        return buildErrorResponse(HttpStatus.NOT_FOUND, exception.getMessage());
    }

    /**
     * Handles IllegalArgumentException — thrown when currency codes
     * are blank or otherwise invalid at the service entry point.
     *
     * @param exception the thrown exception
    ...
    public ResponseEntity<Map<String, Object>> handleGenericException(
        ...
        log.error("Unexpected error in Currency Service: {}", exception.getMessage(), exception);
     ...
     *
     * <p>LinkedHashMap preserves insertion order so the JSON fields
     * always appear in the same order: timestamp, status, error, message.</p>
     *
