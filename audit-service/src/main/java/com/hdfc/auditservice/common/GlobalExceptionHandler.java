package com.hdfc.auditservice.common;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles AuditLogNotFoundException — thrown when an audit log
     * entry with the requested ID does not exist.
     *
     * @param exception the thrown exception
     * @return 404 NOT FOUND with structured error body
     */
    @ExceptionHandler(AuditLogNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleAuditLogNotFoundException(
            AuditLogNotFoundException exception) {

        log.warn("Audit log not found: {}", exception.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleGenericException(
        ...
        log.error("Unexpected error in Audit Service: {}", exception.getMessage(), exception);
